...
from reportlab.pdfgen import canvas # Aunque usamos SimpleDocTemplate, canvas puede ser útil para dibujar manualmente si se necesita
from reportlab.lib.units import inch
from datetime import datetime
import os
import platform # Para abrir el PDF automáticamente
...
class PDFGenerator:
    def __init__(self, filename="constancia_de_estudio.pdf"):
        ...
        # Las rutas de las imágenes ahora serán parámetros en generate_constancia_estudio
    ...
    def generate_constancia_estudio(self, student_data, fecha_expedicion):
        # Asumiendo que las rutas ya fueron seteados por self.set_image_paths()
        # Puedes añadir una verificación aquí si lo deseas, o confiar en que se hace antes de llamar.
...
class ConstanciaApp(QWidget):
    ...
    def init_ui(self):
        ...
        self.setGeometry(100, 100, 900, 700) # Aumentar un poco la altura para los nuevos campos
        ...
        main_layout = QVBoxLayout(self) # Cambiado a QVBoxLayout para usar el splitter en la parte superior
        ...
        # Botón Generar (movido al final de esta sección para el layout del splitter)
        top_splitter.addWidget(right_panel_widget)

        top_splitter.setSizes([300, 600]) # Ajusta el tamaño inicial de los paneles
        ...
        # Botón Generar (ahora en el layout principal para que esté debajo de todo)
    ...
    def select_logo_left(self):
        """Abre un diálogo para seleccionar el archivo del logo izquierdo."""
    ...
    def select_escudo_right(self):
        """Abre un diálogo para seleccionar el archivo del escudo derecho."""
        file_dialog = QFileDialog(self)
        file_dialog.setNameFilter("Archivos de Imagen (*.png *.jpg *.jpeg *.gif *.bmp)")
    ...
    def load_students(self):
        ...
        if students:
            ...
            # Solo mostrar mensaje si hay un texto de búsqueda y no se encontraron resultados
            QMessageBox.information(self, "Información", "No se encontraron estudiantes con ese criterio de búsqueda.")
        else:
            # Si no hay texto de búsqueda y no hay estudiantes, el mensaje ya lo manejará el backend o no es crítico.
            pass
    ...
    def generar_constancia(self):
        ...
        # Verificar si las rutas de imagen son válidas antes de generar
        if not (self.logo_left_path and os.path.exists(self.logo_left_path)):
            ...
            # return # Podrías retornar aquí si quieres que la imagen sea obligatoria
        ...
        self.pdf_gen.filename = pdf_filename # Establecer el nombre del archivo de salida en el generador de PDF
        self.pdf_gen.set_image_paths(self.logo_left_path, self.escudo_right_path) # Pasar las rutas seleccionadas al PDFGenerator
        ...
        try:
            ...
            # Opcional: limpiar la selección después de generar
